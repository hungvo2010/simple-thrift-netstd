...
namespace Server
{
    public class Program
    {
        ...
        {
            // Set args = Array.Empty<string>() if args = null
            args ??= Array.Empty<string>();

            // Check if any args start with -help
            ...
            // object init inside using block will be released after that
        ...
        public class CalculatorAsyncHandler : Calculator.IAsync
        {
            ...
            {
                return add(num1, num2, cancellationToken);
            }

            public Task zip(CancellationToken cancellationToken = default)
            {
